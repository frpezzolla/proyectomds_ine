...
#' 
#' @details 
#' Archivo maestro de ejecución de ajuste estacional.
#' Fecha versión: 19/01/2023
#' 
#' @docType 
#' Master file
#' 
...
##Este script trae la última base y actualiza el datos de las 8 series para el último período
...
# Guardar
save(list = c("X13_dh15","X13_dh25","X13_dm15","X13_dm25","X13_oh15","X13_oh25","X13_om15","X13_om25",
              "stock","SA","forecast","TC"), 
     file = paste0("../Salidas/Estimaciones/SA ",ntm," ",tm," ",yy,".RData"))
